...
string vid_path = "/Users/aparahuja/Deskjtop/trafficvideo.mp4";
//string vid_path = "trafficvideo.mp4";

bool testbase = true; int method_number = 5;
int runTime_avgOver = 5, sleep_time = 25;

//method parameters
vector<int> p1 = {2,3,5,7,9,11,13,15}, p2 = {}, p5 = {1,2,3,4,5,6,7,8}, p6 = {1,2,3,4,5,6,7,8};
vector<vector<int>> p3p4 = {{200,500}};
